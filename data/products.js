class Product {
  ...
  getPrice() {
    return `$${String((Math.round(this.priceCents) / 100).toFixed(2))}`;
  }
...
class Clothing extends Product{
  ...
  extraInfoHTML() {
    return `
    <a href="${this.sizeChartLink}" target="_blank" class="extra-info">Size Chart</a>
    `;
  }
};
...
class Appliance extends Product {
  ...
  extraInfoHTML() {
    return `
      <a href="${this.instructionsLink}" target="_blank" class="extra-info">Instructions Link</a>
      <a href="${this.warrantyLink}" target="_blank" class="extra-info">Warranty Link</a>
    `
  }
}
